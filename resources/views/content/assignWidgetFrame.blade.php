                        ...
                        <div class="col-md-12">
                            <div class="nav-tabs-custom">
                                <ul role="tablist" class="nav nav-tabs flex-column flex-sm-row">
                                    ...
                                    <li class="nav-item"><a data-toggle="tab" href="#tabcss" role="tab" class="nav-link">Applica Style</a></li>
                                    <li class="nav-item"><a data-toggle="tab" href="#tabjs" role="tab" class="nav-link">Javascript</a></li>
                                ...
                                <div class="tab-content" style="height: auto">
                                    ...
                                    <!-- /.tab-pane -->
                                    <div class="tab-pane" id="tabcss" role="tabpanel">
                                        <div class="box-body">
                                            <form action="" method="POST" name="cssForm" id="cssForm">
                                                <div class="form-group">
                                                    <label for="css" class="col-sm-2 form-label">Style avanzato</label>
                                                    <div class="col-sm-10">
                                    ...
                                    <!-- /.tab-pane -->
                                    <div class="tab-pane" id="tabjs" role="tabpanel">
                                        <div class="box-body">
