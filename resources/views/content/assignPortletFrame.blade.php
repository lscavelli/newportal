    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <div class="box box-primary box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">Portlets disponibili</h3>
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                        </div>
                    </div>
                    ...
                    <div class="box-body" style="display: block;">
                    {!!
                         $listPortletsDisp->columns(['id','name'=>'Nome portlet','azioni'])
                            ->sortFields(['id','name'])
                            ->showAll(false)
                            ->setPrefix('RTYX_')
                            ->customizes('azioni', function($row) use($frame) {
                                return "<a href=\"/admin/pages/". $frame['pageId']."/addPortlet/".$row['id']."/".$frame['name']."\" class=\"btn btn-warning btn-xs pull-right\">Aggiungi</a>";
                            })->render()
                     !!}
                    </div>
                    <!-- /.box-body -->
            ...
            <div class="col-md-7">
                ...
                <div class="box box-default">
                    {!!
                         $listPortletsAssign->columns(['id','name'=>'Portlets inserite','azioni'])
                            ->sortFields(['id','name'])
                            ->showActions(false)
                            ->showButtonNew(false)
                            ->setPrefix('HGYU_')
                            ...
                            ->customizes('azioni', function($row) use($frame) {
                                ...
                                <a href=\"#\" data-pivotid=".$row['pivot']['id']." data-pageid=".$frame['pageId']." class=\"btn btn-primary btn-xs pull-right portletpref\" Style=\"margin-right:3px;\"><span class=\"glyphicon glyphicon-pencil\"></span></a>";
                            })->render()
                     !!}
                </div> <!-- /.box -->
            </div>
...
<script>
    ...
    $(".portletpref").click(function() {
        var url = "/admin/pages/"+$(this).data('pageid')+"/configPortlet/"+$(this).data('pivotid');
