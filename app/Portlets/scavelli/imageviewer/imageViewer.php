...
namespace App\Portlets\scavelli\imageviewer;

use App\Portlets\abstractPortlet as Portlet;
use App\Portlets\scavelli\imageviewer\Controllers\imageController;

class imageViewer extends Portlet {
    ...
    public function configPortlet($portlet) {
        return (new imageController($this->rp))->configPortlet($portlet, $this);
    }
