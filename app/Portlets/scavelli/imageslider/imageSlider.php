...
namespace App\Portlets\scavelli\imageslider;

use App\Portlets\abstractPortlet as Portlet;
use App\Portlets\scavelli\imageslider\Controllers\imageSliderController;
...
class imageSlider extends Portlet {
    ...
    public function configPortlet($portlet) {
        return (new imageSliderController($this->rp))->configPortlet($portlet, $this);
    }
