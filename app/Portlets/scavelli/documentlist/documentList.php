...
namespace App\Portlets\scavelli\documentlist;

use App\Portlets\abstractPortlet as Portlet;
use App\Portlets\scavelli\documentlist\Controllers\documentController;

class documentList extends Portlet {
    ...
    public function getContent() {
        ...
        if (!$this->config('template')) {
            return view("documentlist::$listView")->with([
                'items' => $items,
